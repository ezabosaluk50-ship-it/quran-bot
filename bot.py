...
# --- البيانات الأساسية (القراء والسور) ---
READERS_LIST = [
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("page_"):
        ...
        try:
            ...
            await context.bot.send_message(chat_id=query.message.chat_id, text="❌ عذراً، هذا الملف غير متوفر حالياً.")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif "إحصائيات" in text or text == "/stats":
